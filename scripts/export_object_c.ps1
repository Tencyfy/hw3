...
if ($TrialDir -eq "") {
    $SearchRoot = Join-Path $ProjectRoot "outputs\object_c\hw3-object-c-stable-zero123"
    if (-not (Test-Path $SearchRoot)) {
        throw "Cannot find trial directory under '$SearchRoot'. Train object C first or pass -TrialDir."
    }
